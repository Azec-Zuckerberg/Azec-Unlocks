...
export default function UnlockAllCarousel() {
  ...
  return (
    <div className="relative w-full max-w-xl mx-auto aspect-video rounded-2xl overflow-hidden shadow-xl bg-gradient-to-br from-black/80 via-[#1a1a1a]/80 to-black/60 border border-white/10 flex items-center justify-center">
